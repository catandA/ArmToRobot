package com.catand.armtorobot.connect;
...
import com.catand.armtorobot.model.Command;
import com.catand.armtorobot.uitls.Configs;
import com.catand.armtorobot.uitls.LogUtil;
import com.catand.armtorobot.uitls.TimerLog;
...
public class BluetoothService {
	 ...
	 *
	 * @param device The BluetoothDevice to com.catand.armtorobot.connect
	 * @param secure Socket Security type - Secure (true) , Insecure (false)
	 */
	public synchronized void connect(BluetoothDevice device, boolean secure) {
		LogUtil.d(TAG, "com.catand.armtorobot.connect to: " + device);
		...
		// Start the thread to com.catand.armtorobot.connect with the given device
	...
	class ConnectThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				LogUtil.e(TAG, "com.catand.armtorobot.connect failure --- " + e);
				// Close the socket
				try {
					mmSocket.close();
		...
		public void cancel() {
			try {
				...
				LogUtil.e(TAG, "close() of com.catand.armtorobot.connect " + mSocketType + " socket failed", e);
			}
		}
	}
...
//            } catch (IOException e) {
//                e.printStackTrace();
//                LogUtil.e(TAG, "close() of com.catand.armtorobot.connect socket failed", e);
//            }
//            try {
//                if (mmOutStream != null) {
