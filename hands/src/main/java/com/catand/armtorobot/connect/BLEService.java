...
//                    }
				...
				case BluetoothProfile.STATE_DISCONNECTED:
					if (mConnectState == BluetoothProfile.STATE_CONNECTING) {
						...
						LogUtil.i(TAG, "onConnectionStateChange --- com.catand.armtorobot.connect failed!");
					} else {
	...
	public boolean connect(final String address) {
		...
		if (device == null) {
			LogUtil.w(TAG, "Device not found.  Unable to com.catand.armtorobot.connect.");
			return false;
		}
		// We want to directly com.catand.armtorobot.connect to the device, so we are setting the autoConnect
		// parameter to false.
